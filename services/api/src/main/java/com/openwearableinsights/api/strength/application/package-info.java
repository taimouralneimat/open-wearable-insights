/**
 * Named interface: strength-training application services.
 *
 * <p>Exposed so other modules (e.g. healthspan — see {@code
 * healthspan.application.HealthspanService}, which composes the real
 * "Strength Activity Time" trend into its own composite score) may invoke
 * {@code StrengthTrainingService} directly rather than reaching into this
