...
> QA review is an independent gate. This document is a living artifact.
...
- Each story in `docs/product/backlog.md` has acceptance criteria.
- PRs link the story and list criteria addressed.
- QA review verifies traceability before merge.