...
| 2 | Strain | Daily & activity strain | competitor public docs | 2026-07-18 | HR zones, activity duration | Partial | Yes | Transparent internal training-load model | Training-load view | HR-zone load + TRIMP variants + ACWR | 🟢 | ☐ | Need activity parsing | High | Load values normalized with provenance; no incomparable mixing | None |
